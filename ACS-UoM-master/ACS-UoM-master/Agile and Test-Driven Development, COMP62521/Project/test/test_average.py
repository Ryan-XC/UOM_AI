...
class TestAverage(unittest.TestCase):
    ...
    def test_mean_real_number_values(self):
        self.assertEqual(average.mean([2.4, 2.8, 3.4, 4.2, 6.4]), 3.8400000000000007)

    def test_mean_returns_negative(self):
        self.assertEqual(average.mean([-1, -4, -7, -3]), -3.75)
    ...
    def test_median_real_number_values(self):
        self.assertEqual(average.median([2.4, 2.8, 3.4, 4.2, 6.4]), 3.4)

    def test_median_returns_negative(self):
        self.assertEqual(average.median([-1, -4, -7, -3]), -3.5)
